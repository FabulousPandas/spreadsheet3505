...
namespace SS
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        private class DrawingPanel : Panel
        {
            ...
            /// <summary>
            /// Looks for if the column or row given are outside of the set bound
            /// </summary>
            /// <param name="col"></param>
            /// <param name="row"></param>
            /// <returns></returns>
            ...
            /// <summary>
            /// Sets the value for the given column and row cell with the given string
            /// </summary>
            /// <param name="col"></param>
            /// <param name="row"></param>
            /// <param name="c"></param>
            ...
            /// <summary>
            /// Returns the value of the given column and row cell as a string
            /// </summary>
            /// <param name="col"></param>
            /// <param name="row"></param>
            /// <param name="c"></param>
            ...
            /// <summary>
            /// Sets the selection of the colum and row
            /// </summary>
            /// <param name="col"></param>
            /// <param name="row"></param>
            /// <returns></returns>
            ...
            /// <summary>
            /// Get's the column and row selected
            /// </summary>
            /// <param name="col"></param>
            /// <param name="row"></param>
            public void GetSelection(out int col, out int row)
            ...
            /// <summary>
            /// Draws all the parts of the spreadsheet
            /// </summary>
            /// <param name="e"></param>
